...
export const styles: { [key: string]: React.CSSProperties } = {
  ...
  shipCombatStartBanner: {
    ...
    color: '#ffe8bf',
    background: 'linear-gradient(90deg, rgba(38,22,8,0.9), rgba(62,34,12,0.78))',
    border: '1px solid rgba(245, 158, 11, 0.22)',
    borderLeft: '3px solid #f59e0b',
    textTransform: 'uppercase' as const,
  },
  shipCombatOpeningNarration: {
    marginBottom: '8px',
    padding: '6px 10px',
    borderRadius: '6px',
    fontSize: '12px',
    lineHeight: 1.35,
    color: '#f7e6c7',
    background: 'rgba(38, 22, 8, 0.28)',
    border: '1px solid rgba(245, 158, 11, 0.12)',
  },
  shipNpcActionNotification: {
    padding: '4px 10px',
    borderRadius: '4px',
    fontSize: '12px',
    fontFamily: 'monospace',
  ...
  expenseConsequenceNotification: {
    padding: '4px 10px',
    borderRadius: '4px',
    fontSize: '12px',
    fontFamily: 'monospace',
